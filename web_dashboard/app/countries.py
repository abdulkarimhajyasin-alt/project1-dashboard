COUNTRIES = sorted(
    [
        ...
        {"name": "Cote d'Ivoire", "timezone": "Africa/Abidjan"},
...
COUNTRY_TIMEZONE_MAP = {country["name"]: country["timezone"] for country in COUNTRIES}
COUNTRY_TIMEZONE_CHOICES = [(country["name"], country["timezone"]) for country in COUNTRIES]


def get_country_timezone(country_name: str | None) -> str | None:
    return COUNTRY_TIMEZONE_MAP.get((country_name or "").strip())
