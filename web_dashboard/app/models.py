...
class MiningCycle(Base):
    ...
    full_daily_income: Mapped[Decimal] = mapped_column(Numeric(12, 4), default=0, nullable=False)
    final_income: Mapped[Decimal] = mapped_column(Numeric(12, 4), default=0, nullable=False)
    final_income_after_time_deduction: Mapped[Decimal] = mapped_column(Numeric(12, 4), default=0, nullable=False)
